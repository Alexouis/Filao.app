  ...
  const renderList = () => (
    <div className={`flex-1 ${GLASS_STYLE} rounded-3xl flex flex-col overflow-hidden h-full animate-in fade-in slide-in-from-bottom-4 duration-500`}>
        ...
        <BarreFiltresDossiers
          ...
          showInvitationsOnly={showInvitationsOnly}
          setShowInvitationsOnly={setShowInvitationsOnly}
          voirToutEntreprise={voirToutEntreprise}
          setVoirToutEntreprise={setVoirToutEntreprise}
          nbDossiersCollegues={nbDossiersCollegues}
