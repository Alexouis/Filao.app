...
import { OnboardingCompetences } from './OnboardingCompetences';
...
export const OnboardingWizard: React.FC<OnboardingWizardProps> = ({ userProfile, onComplete }) => {
    ...
    const reinitialiserActivite = () => {
        ...
        setSelectedZones([]);
        // L'accordéon des domaines vit dans `OnboardingCompetences` : il ne se
        // déplie que pour les domaines SÉLECTIONNÉS, donc vider la sélection
        // suffit à le refermer. Rien à réinitialiser ici.
    };

    /**
     * Libellé libre saisi pour une spécialité « Autre », par identifiant.
     *
     * Reste ICI et non dans `OnboardingCompetences` : il est AMORCÉ depuis la
     * base au chargement du profil (spécialités déjà déclarées). Le descendre
     * obligerait à le faire remonter aussitôt pour l'enregistrement.
     */
                ...
                <div className="w-full max-w-2xl">
                    ...
                    {step === 1 && (
                        <OnboardingCompanyStep
                            ...
                            onRechercherSiret={handleSiretSearch}
                            entryMode={entryMode}
                            ...
                            nomRattachement={nomRattachement}
                    ...
                    {step === 2 && (
                        <OnboardingCompetences
                            ...
                            setOtherLabels={setOtherLabels}
                            onDemanderRetraitNature={setRetraitNatureAConfirmer}
                            onAppliquerRetraitNature={appliquerRetraitNature}
                        />
                    )}
