        ...
        <div className="space-y-3">
            ...
            {subTab === 'docs' && (
                <CompanyDocsTab
                    ...
                    standardDocSlots={STANDARD_DOC_SLOTS}
                    uploadingField={uploadingField}
                    addingInCategory={addingInCategory}
                    setAddingInCategory={setAddingInCategory}
                    newDocLabel={newDocLabel}
                    setNewDocLabel={setNewDocLabel}
                    standardDocExpiry={standardDocExpiry}
                    setStandardDocExpiry={setStandardDocExpiry}
                    formData={formData}
